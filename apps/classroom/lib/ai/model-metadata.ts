...
const THINKING_CAPABILITIES: Record<string, ThinkingCapability> = {
  ...
  // Judge tier for the hallucination-audit gate. GLM exposes the same toggleable
  // thinking budget as its siblings here; the audit itself runs without thinking.
  [getModelMetadataKey('siliconflow', 'zai-org/GLM-5.2')]: siliconflowToggleBudget,
  [getModelMetadataKey('siliconflow', 'Qwen/Qwen3.5-397B-A17B')]: siliconflowToggleBudget,
  [getModelMetadataKey('siliconflow', 'MiniMaxAI/MiniMax-M2.5')]: siliconflowToggleBudget,
  [getModelMetadataKey('siliconflow', 'Qwen/Qwen3.5-122B-A10B')]: siliconflowToggleBudget,
