...
- LECTURE FORM: The main canvas shows a full written lecture the learner is reading — explanation is NOT scarce. Never dispatch an agent to re-explain or summarize on-screen text. Route for Socratic value: a follow-up question, a counter-example, a request for a diagram, a check question, or a direct answer to the learner.
