 ...
 *
 * 2026-08-31 曾从 /evidence 撤下，2026-09-03 挂回页尾。文件保留不删：
...
const LEDGER = [
  ...
  },
  {
    ...
    value: '0.226 / 0.447',
    caliber:
      'RAGTruth QA 测试集 900 条（含幻觉 160），响应级。确定性层单独判 0.226；生产同构两级审核（确定性初筛 + 判官复核存疑句，判官看完整 passage）0.447；判官审全部句子 0.428。外部公开数据集，非自证，2026-09-03 全量复测。',
    source:
