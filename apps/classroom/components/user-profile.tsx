...
export function UserProfileCard() {
  ...
  if (!hydrated) {
    return (
      <Card className="p-5 !gap-0 shadow-card border-border bg-card">
  ...
  return (
    <Card className="p-5 !gap-0 shadow-card border-border bg-card">
      ...
      <div className="flex items-center gap-3.5">
        ...
        >
          <div className="size-11 rounded-full bg-muted overflow-hidden ring-2 ring-purple-deep/30 group-hover/avatar:ring-purple-deep/60 transition-all">
            <img src={avatar} alt="" className="size-full object-cover" />
          </div>
          <div className="absolute -bottom-0.5 -right-0.5 size-4 rounded-full bg-card border border-border-subtle flex items-center justify-center">
            <ChevronDown
              className={cn(
        ...
        <div className="flex-1 min-w-0">
          {editingName ? (
            <div className="flex items-center gap-1.5">
              ...
              <button
                onClick={commitName}
                className="shrink-0 size-6 rounded-md flex items-center justify-center text-primary hover:bg-purple-soft transition-colors"
              >
            ...
            <div className="pt-3 pb-1 px-1 flex items-center gap-1.5 flex-wrap">
              {AVATAR_OPTIONS.map((url) => (
                <button
                  ...
                  className={cn(
                    'size-8 rounded-full overflow-hidden bg-muted cursor-pointer transition-all duration-150',
                    'active:scale-95',
                    avatar === url
              ...
              <label
                ...
                className={cn(
                  ...
                  isCustomAvatar(avatar)
                    ? 'ring-2 ring-primary ring-offset-1 ring-offset-background border-purple-deep/30 bg-purple-soft'
