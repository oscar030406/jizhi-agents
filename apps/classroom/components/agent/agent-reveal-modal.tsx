...
export function AgentRevealModal({ agents, open, onClose, onAllRevealed }: AgentRevealModalProps) {
  ...
  return (
    <AnimatePresence>
      {open && (
        <motion.div
          className="fixed inset-0 z-[100] flex flex-col items-center justify-center bg-background/90 backdrop-blur-sm dark:bg-black/70 dark:backdrop-blur-md"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
        ...
        >
          ...
          {allRevealed && (
            <motion.button
              className="absolute right-4 top-4 flex size-9 items-center justify-center rounded-full bg-black/5 text-muted-foreground backdrop-blur-sm transition-colors hover:bg-black/10 hover:text-foreground dark:bg-white/10 dark:text-white/70 dark:hover:bg-white/20 dark:hover:text-white"
          ...
          >
            <Sparkles className="mr-2 inline-block size-6 text-yellow-deep" />
                      ...
                      >
                        ...
                        <div className="relative flex size-full flex-col overflow-clip rounded-[14px] bg-card">
                          ...
                          <div className="relative z-10 -mt-7 flex justify-center">
                            <div
                              className="flex size-[50px] items-center justify-center rounded-full border-[2.5px] shadow-card"
                              style={{
              ...
              {agents.map((_, index) => (
                <div
                  ...
                  className={cn(
                    ...
                    index < revealedCount ? 'bg-foreground' : 'bg-border',
                  )}
                />
              ))}
            </div>
