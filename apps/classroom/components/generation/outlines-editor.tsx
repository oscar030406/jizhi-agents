...
> = {
  ...
  pbl: {
    ...
    chipHover: 'hover:bg-yellow-soft/80',
    accent: 'bg-yellow-deep',
    dot: 'bg-yellow-deep',
  },
};
  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        'bg-white/85 shadow-dropdown backdrop-blur-xl',
        'dark:border-white/5 dark:bg-card/70',
      )}
    >
      {/* Soft gradient wash */}
        ...
        <div className="min-w-0 flex-1 space-y-1.5">
          ...
          <div className="flex items-start justify-between gap-2">
            {!disabled && !outline.title.trim() && (
              ...
              <span aria-hidden className="mt-[11px] h-2 w-2 shrink-0 rounded-full bg-yellow-deep" />
            )}
            <textarea
              ref={titleRef}
              value={outline.title}
      ...
      >
        ...
        <span
          className={cn(
            ...
            isEdge
              ? 'size-4 bg-muted-foreground/60 group-hover/insert:size-5 group-hover/insert:bg-blue-500'
              : 'size-5 bg-blue-500',
          )}
        >
      ...
      <PopoverContent align="start" sideOffset={6} className="w-72 space-y-2.5 p-3">
        ...
        <div className="space-y-1.5">
          ...
          <input
            ...
            className={cn(
              'w-full rounded-md border border-border/50 bg-background px-2 py-1.5 text-xs',
              'focus:border-yellow-deep/50 focus:outline-none focus:ring-0',
            )}
          />
        </div>
        <div className="space-y-1.5">
          ...
          {skills.length > 0 && (
            <div className="flex flex-wrap gap-1">
              {skills.map((skill) => (
                <span
                  key={skill}
                  className="inline-flex items-center gap-1 rounded-full bg-yellow-soft px-2 py-0.5 text-xs text-yellow-deep"
                >
                  {skill}
                  <button
                    type="button"
                    ...
                    className="inline-flex size-3 items-center justify-center rounded-full hover:bg-yellow-deep/20"
                  >
                    <X className="size-2.5" />
                  </button>
                </span>
