    ...
    >
      <div className="relative">
        ...
        <button
          ...
          className="absolute -top-2 -right-2 w-6 h-6 bg-white dark:bg-gray-800 shadow-card border border-gray-100 dark:border-gray-700 rounded-full flex items-center justify-center text-gray-400 hover:text-red-500 transition-all z-20 group/close"
          ...
          <div className="flex items-center gap-2 px-0.5 pt-1">
            ...
            <span
              className={`text-[10px] font-bold tabular-nums shrink-0 ${
                isPaused ? 'text-gray-300 dark:text-gray-600' : 'text-gray-500 dark:text-gray-400'
              }`}
            >
