...
function CollapsedBubblePill({
  ...
  return (
    <div className="flex items-center gap-2" onClick={onExpand}>
      <div
        className={cn(
          'flex items-center gap-2 px-3 py-1.5 rounded-full border backdrop-blur-xl shadow-card cursor-pointer transition-all duration-200',
          'active:scale-[0.98]',
          bubble.role === 'user'
      ...
      {onPlayPause && (
        <div
          ...
          className={cn(
            'p-2 rounded-full border backdrop-blur-xl shadow-card cursor-pointer transition-all duration-200',
            'active:scale-[0.98]',
            bubble.role === 'user'
