              ...
              {isInputOpen && (
                ...
                >
                  <div
                    ...
                    className="relative w-fit max-w-[85%] sm:max-w-[65%] min-w-[200px] sm:min-w-[300px] bg-white/90 dark:bg-gray-800/90 backdrop-blur-md p-2 pr-2 rounded-2xl rounded-br-none shadow-dropdown border border-purple-200 dark:border-purple-700 flex items-end gap-2 ring-1 ring-purple-100/50 dark:ring-purple-800/50"
                  >
                    ...
                    <button
                      ...
                      disabled={isSendCooldown}
                      className={cn(
                        'p-2.5 text-white rounded-xl transition shadow-card mb-0.5 shrink-0',
                        isSendCooldown
                ...
                >
                  ...
                  <div className="relative flex items-center justify-center">
                    ...
                    <motion.button
                      ...
                      className={cn(
                        'relative w-11 h-11 rounded-full flex items-center justify-center shadow-card cursor-pointer active:scale-95 z-10 bg-gradient-to-br',
                        asrEnabled
                  ...
                  >
                    <div
                      ...
                      className={cn(
                        ...
                        bubbleRole === 'user'
                          ? 'bg-purple-600/95 dark:bg-purple-500/95 backdrop-blur-sm border-purple-400/40 dark:border-purple-300/40 text-white rounded-br-sm shadow-card'
                          : bubbleRole === 'agent'
                            ? cn(
                                ...
                                (isInLiveFlow || isTopicPending) &&
                                  'hover:drop-shadow-card-hover cursor-pointer',
                              )
                            : 'bg-white dark:bg-gray-800 border-gray-100 dark:border-gray-700 text-gray-700 dark:text-gray-200 rounded-bl-sm shadow-sm hover:drop-shadow-card-hover cursor-pointer',
                      )}
                    >
                      {bubbleRole &&
                        (() => {
          ...
          <div className="flex-1 flex items-center justify-center gap-3 px-2 min-h-0">
            ...
            >
              ...
              >
                ...
                <div className="absolute top-0 right-0 w-5 h-5 bg-white dark:bg-gray-800 rounded-full flex items-center justify-center shadow-sm border border-gray-100 dark:border-gray-700 z-20">
                  <div
                    className={cn(
                      'w-1.5 h-1.5 rounded-full',
